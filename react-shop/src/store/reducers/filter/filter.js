...
const filterReducer = (state = initialState, action) => {
	switch (action.type) {
		case UPDATE_BRANDS: return updateObject(state, { brands: action.brands });
		case UPDATE_PRICES: return updateObject(state, { prices: action.prices });
		case UPDATE_SIZES: return updateObject(state, { sizes: action.sizes });
